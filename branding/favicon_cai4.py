"""'C.ai' favicon — larger .ai relative to C, padded fit."""
...
def group(sizeC=300, sizeAI=160, gap=10, track=-3):
    ...
    base, ascC, ascA = 400, fontC.getmetrics()[0], fontA.getmetrics()[0]
    x = 60
...
sheet.convert("RGB").save(f"{OUT}/favicon_cai4.png")
print("wrote favicon_cai4.png")
