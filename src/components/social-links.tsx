...
const socials = [
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/clupai",
    external: true,
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/clupai",
    external: true,
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
      ...
      {socials.map((s) =>
        s.external ? (
          <a
            ...
            className="cp-rail-social"
            aria-label={s.label}
          >
            {s.icon}
          </a>
        ) : (
          <Link key={s.label} href={s.href} className="cp-rail-social" aria-label={s.label}>
            {s.icon}
          </Link>
        )
      )}
